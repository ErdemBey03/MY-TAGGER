...
async def start(event):
  await event.reply("**MЄƦӇƛƁƛ** TOXİC TAGGER ƁƠƬ GÜNCELLENMİŞ HALİYLE KARŞINIZDA...! ƁЄƝƖ ƓƦƲƁƛ ƳƠƝЄƬƖƇƖ ƠԼƛƦƛƘ ЄƘԼЄƳƖƝ ƓЄƦƖƧƖƝƖ ƁƛƝƛ ƁƖƦƛƘƖƝ. \n\n ƘƠMƲƬԼƛƦƖMƖ GÖRMEK ƖÇƖƝ /help ƳƛȤƖƝ. ",
                    buttons=(
                      [
                         Button.url('➕ ƓƦƲƁƛ ЄƘԼЄ ➕ ', 'http://t.me/Majeste_TaggerBot?startgroup=a')
                      ],
                      [
                         Button.url('📣 KANAL', 'https://t.me/pubgvipcheat01'),
                         Button.url('👮 DEVELOPER', 'https://t.me/onlinewof'),
                         Button.url('🎆 SUPPORT', 'https://t.me/pubglitefucker')
                      ]
                    ),
                    link_preview=False
                   )
...
async def help(event):
  helptext = "**Toxic Tagger Botun Komutları**\n\n/utag - Üyeleri 5 ԼƖ etiketler . \n /etag - üyeleri emoji ile etiketler \n /itag - üyeleri güzel isimlerle etiketler . \n /hiztag - üyeleri aşırı hızlı bir şekile etiketler \n /tektag - herkesi ƬЄƘ ƬЄƘ ЄƬƖƘЄƬԼЄƦ \n\n **Komutları Sadece Yöneticiler Kullanabilir...!**"
  await event.reply(helptext,
                    buttons=(
                      [
                         Button.url('➕ ƓƦƲƁƛ ЄƘԼЄ ➕', 'http://t.me/toxicrobbot?startgroup=a')
                      ],
                      [
                         Button.url('📣 kanal', 'https://t.me/pubgvipcheat01'),
                         Button.url('👮sahip', 'https://t.me/onlinewof'),
                         Button.url('🎆 grup', 'https://t.me/pubglitefucker')
                      ]
                    ),
                    link_preview=False
                   )
...
print(">> Bot Deploy edildi merak etme 🚀 @onlinewof bilgi alabilirsin <<")
